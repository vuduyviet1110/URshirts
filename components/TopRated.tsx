    ...
    <section className="py-10 border-t">
      <div className="main-container">
        <div className="flex justify-between items-center">
          <h1 className="text-xl uppercase border-b border-gray-900 text-gray-900">Top Products</h1>
        ...
        <div className="grid lg:grid-cols-4 gap-5 grid-cols-2">
          {topProducts.map(product => {
            return <ProductsCard key={product.id} productId={product.id} product={product} />;
          })}
        </div>
      </div>
    </section>
