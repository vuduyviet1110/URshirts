        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at URshirt believe that a shirt doesn&apos;t only need to look good, but also last
              you for the years to come. We offer a 5-year print guarantee: If your shirt isn&apos;t
              of the highest quality, we&apos;ll exchanged it for free.
            </p>
          </div>
        </div>
